import random
def contraPc():
    print("Você escolhe jogar contra a máquina!")
    print('1 - a - pedra')
    print('2 - b - papel')
    print('3 - c - tesoura')
...
def contraPessoa():
    ...
    if escolha1.lower() == "a" or escolha1.lower() == "pedra":
        ...
        escolha1 ="3"
    elif escolha2.lower() == "a" or escolha2.lower() == "pedra":
        escolha2 ="1"
    ...
    elif (escolha2 == '1'and escolha1 == '3') or (escolha2 == '2' and escolha1 == '1') or (escolha2 == '3' and escolha1 == '2'):
